...
class TableController extends Controller
{
    ...
    public function update(TableUpdateRequest $request, Table $table)
    {
        ...
        return to_route('admin.tables.index')->with('success', 'Category updated successfully');
    }
    ...
    public function destroy(Table $table)
    {
        ...
        return to_route('admin.tables.index')->with('success', 'Category deleted successfully');
    }
}
